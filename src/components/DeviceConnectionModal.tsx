      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-800">{getDeviceTitle()}</h2>
              <p className="text-sm text-gray-600">{getDeviceDescription()}</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {connectionStep === 'select' && (
          <div className="p-6">
            ...
            <div className="space-y-3 mb-6">
              <h3 className="font-semibold text-gray-800">Choose your {deviceType === 'smartwatch' ? 'smartwatch' : 'calendar'} provider:</h3>
        ...
        {connectionStep === 'success' && (
          <div className="p-8 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Successfully Connected!</h3>
            <p className="text-gray-600">
